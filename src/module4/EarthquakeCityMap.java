...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		int triangleSize = 6;
		fill(255, 0, 0);
		triangle(50, 100-triangleSize , 50-triangleSize, 100+triangleSize, 50+triangleSize, 100+triangleSize);
	 ...
	 * */
	private void printQuakes() throws ClassNotFoundException 
	{
		...
		Map<String, Integer> countryQuakeMap = new HashMap<String, Integer>();
		for (Marker marker : quakeMarkers) {
			//System.out.println(marker);
			if (!marker.getProperties().containsKey("country"))
				numOceanQuakes++;
			else {
				String country = (String) marker.getProperties().get("country");
				if (countryQuakeMap.containsKey(country))
					countryQuakeMap.put(country, countryQuakeMap.get(country) + new Integer(1));
				else
					countryQuakeMap.put(country, new Integer(1));
			}
